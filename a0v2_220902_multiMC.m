...
%% Results
        ...
        if n_monteCarlo==1 && isnr==1, outputsSBLv4_Esa = []; end
        outputSBLv4_Esa = struct('theta',phi_vec(Ilocs),'error',DoA_error);
        outputsSBLv4_Esa = [outputsSBLv4_Esa; outputSBLv4_Esa];
    ...
    save(['SNRn',num2str(isnr),'SimN',num2str(NmonteCarlo)],...
    'SNRs','NmonteCarlo',...
    'outputsSBLv4p00','outputsSBLv4p11','outputsSBLv4p14',...
    'outputsSBLv4_Esa','outputsSBLv5p01','outputsSBLv5p04',...
    'outputsSBLv4_EsaT','outputsSBLv4_T','outputsSBLv5p01T','outputsSBLv5p04T',...
    'outputsSBLv4_EsaH','outputsSBLv4_H','outputsSBLv5p01H','outputsSBLv5p04H'...
    )
