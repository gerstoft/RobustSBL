...
for ialgorithm = 6 %[0,1,3,4,5]
    ...
    switch(ialgorithm)
       ...
       % case 2, algorithm = 'SBL4-tM-estim', nu_algorithm = 2.1, nu_algorithm_string = '2p1';
        ...
        case 6, algorithm = 'SBL4-tM-estim-b-free', nu_algorithm = 2.1, nu_algorithm_string = '2p1';
 ...
 %      rng(isnr, 'twister'); % mix the random number seeds
        ...
        parfor ell = 1 : LL/L
            ...
            switch(algorithm)
                ...
                case 'SBL4-tM-estim-Esa',     [gamma,sigc,report] = SBL_v4_tM_esa(A, Y, nu_algorithm, Number_of_DOAs);
                case 'SBL4-M-estim-Huber',    [gamma,sigc,report] = SBL_v4_M_icassp( A , Y , 'Huber', nu_algorithm, Number_of_DOAs);
                case 'SBL4-tM-estim-b-free',  [gamma,sigc,report] = SBL_v4_tM_b_free(A, Y, nu_algorithm, Number_of_DOAs);
